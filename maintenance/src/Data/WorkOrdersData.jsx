export const workOrders = [
...

  {
    ...
    description:
      "Project was part of the boiler's routine maintenance, where the internal surfaces of the boiler's furnace and flue gas passeges are cleaned to remove soot and scale buildup thus enhancing the boiler's thermal efficiency by improving heat transfer",
    machine: "Boiler",
    location: "Boiler Room",
    priority: "high",
    status: "Completed",
    activityType: "Routine Maintenance",
    projectLead: "James Njonge",
...

  {
    ...
    statusReport:
      "First and second canopis complete are currently complete. The building of the third and final canopy is expected to begin in the coming week.",
  },

  {
    ...
    numberOfPersonellRequired: "4 Individuals",
    requiredMaterials: [
      "Iron sheets 2m- Green - 14pcs",
      "Iron sheets 3m Green - 13pcs",
      "Iron sheets 2.5m - Grey -10pcs",
      "RHS 3 by 2 - 8pcs",
      "RHS 2 by 2 - 10pcs",
      "wire mesh (heavy gauge) - 5pcs",
    ],
    statusReport:
      "The support bases have been built and will cure for 21 days to achieve maximum strength. Fabrication of the workshop’s support frame will begin in the coming days and the frame will be assembled on site following base curing.",
  },

  {
    id: 19,
    title: "Overhaul and Rewiring of the Bagging Scales Control System",
    description:
      "Project entailed a complete overhaul and rewiring of the bagging scales' control system in an attempt to address frequent system failures that caused production downtimes.",
    machine: "Bagging Scales",
    location: "0 meter level - Bagging Area",
    priority: "high",
    status: "Completed",
    activityType: "Corrective Maintenance",
    projectLead: "George Kimani",
    assignedPersonnel: "George Kimani",
    createdAt: "2025-10-05",
    attendedBy: "Maintenance Team",
    createdAt: "2025-10-07",
    startedon: "2025-09-08",
    completedon: "2025-09-08",
    nextServiceDate: null,
  },

  {
    ...
    description: "task entailed replacement of the wornout v-belts",
    machine: "Hammer Mill Dust Collector extractor fan",
    location: "Plant's +6 meter level",
    priority: "medium",
    status: "Completed",
    activityType: "Corrective Maintenance",
    projectLead: "Patrick Muiruri",
    createdAt: "2025-10-22",
    attendedBy: "Patrick Muiruri",
    completedon: "2025-10-22",
    nextServiceDate: null,
  },

  {
    id: 21,
    title: "Inspection and Service of the Molasses Pump",
    description:
      "Task entailed a scheduled inspection and servicing of the molasses pump to ensure optimal performance. The activity included the fabrication and replacement of a worn-out key to minimize gear play on the shaft, replacement of a broken coupling. replacement of worn-out circlips, and replacement of the worn-out shaft.",
    machine: "Molasses Pump",
    location: "Plant's +26 meter level",
    priority: "medium",
    status: "Completed",
    activityType: "Corrective Maintenance",
    projectLead: "Martin Kimani",
  ...
  {
    id: 22,
    title: "Belts Replacement",
    description:
      "Task entailed replacement of the worn-out v-belts",
    machine: "Pre-cleaner Intake 2",
    location: "Plant's +26 meter level",
    priority: "medium",
    status: "Completed",
    activityType: "Corrective Maintenance",
